                                ...
                                @foreach($Material as $material_detail)
                                    <div class="d-flex align-items-center border-dashed-bottom py-3">
                                        <div class="flex-grow-1 ms-2">
                                            <h5 class="m-0">Material Name:</h5><span>{{ $material_detail -> material }}</span>
                                    ...
                                    <div class="d-flex align-items-center border-dashed-bottom py-3">
                                        <div class="flex-grow-1 ms-2">
                                            <h5 class="m-0">Category Name:</h5><span>{{$material_detail -> category_name  }}</span>
                                            
                                        </div><!--end media-body-->
                                    </div><!--end media--> 
                                    <div class="d-flex align-items-center border-dashed-bottom py-3">
                                        <div class="flex-grow-1 ms-2">
                                            <h5 class="m-0">Description:</h5><span>{{ $material_detail -> description }}</span>

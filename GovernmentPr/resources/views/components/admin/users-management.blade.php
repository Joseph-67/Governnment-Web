                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <button class="btn bg-primary-subtle text-primary" data-bs-toggle="modal" data-bs-target="#exampleModalLarge"><i class="fas fa-plus me-1"></i> Add User</button>
                                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalSmall"><i class="fas fa-plus me-1"></i> Invite User</button>
                                    </div><!--end col-->
                                </div><!--end row-->
                            </div><!--end card-header-->
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="d-flex align-items-center">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{asset('adminAssets/images/users/avatar-1.jpg')}}" class="me-2 thumb-md align-self-center rounded" alt="...">
                                    ...
                                    <table class="table mb-0" id="datatable_1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="d-flex align-items-center">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{asset('adminAssets/images/users/avatar-5.jpg')}}" class="me-2 thumb-md align-self-center rounded" alt="...">
                                                        <div class="flex-grow-1 text-truncate">
                                            ...
                                            <tr>
                                                <td class="d-flex align-items-center">
                                                    <div class="d-flex align-items-center">
                                                        <img src="{{asset('adminAssets/images/users/avatar-2.jpg')}}" class="me-2 thumb-md align-self-center rounded" alt="...">
                                                        <div class="flex-grow-1 text-truncate">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title m-0" id="myLargeModalLabel">Add User</h6>

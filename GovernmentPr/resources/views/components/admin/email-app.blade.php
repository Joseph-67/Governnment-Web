        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-md-3 email-sidebar">
              ...
              <button class="btn btn-purple w-100 mb-3" type="button" data-bs-toggle="collapse"
                data-bs-target="#composeForm" aria-expanded="false" aria-controls="composeForm">
                NEW MAIL
              </button>
              <a href="#" class="d-block mb-3">Inbox</a>
              <a href="#" class="d-block mb-3" data-bs-toggle="collapse" data-bs-target="#allMails"
                aria-expanded="false" aria-controls="allMails">All Mail</a>

            ...
            <div class="col-md-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5 class="fw-semibold mt-3 fs-14">Featured Posts</h5>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <img src="{{asset('adminAssets/images/logos/lang-logo/gdrive.png')}}" class="me-2 align-self-center thumb-xl" alt="...">
                        <h5 class="fw-semibold mt-3 fs-14">Tags</h5>
                        <div class="d-flex justify-content-between my-2">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <img src="{{asset('adminAssets/images/logos/lang-logo/gdrive.png')}}" class="me-2 align-self-center thumb-xl" alt="...">
                        <h5 class="fw-semibold mt-3 fs-14">Drafts</h5>
                        <div class="d-flex justify-content-between my-2">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <img src="{{asset('adminAssets/images/logos/lang-logo/gdrive.png')}}" class="me-2 align-self-center thumb-xl" alt="...">
                        <h5 class="fw-semibold mt-3 fs-14">Trash</h5>
                        <div class="d-flex justify-content-between my-2">

      ...
      <div class="tpoffcanvas">
         ...
         <div class="tpoffcanvas__contact-info">
            ...
            <ul>
               ...
               <li>
                  ...
                  <a href="https://template.wphix.com/cdn-cgi/l/email-protection#c2b1adaea3b0a7a6a5a782a5afa3abaeeca1adaf"><span class="__cf_email__" data-cfemail="ccb8a4a9a1a9bcb9bea98caba1ada5a0e2afa3a1">[email&#160;protected]</span></a>
               </li>
               <li>
         ...
         <div class="tpoffcanvas__social">
            <div class="social-icon">
               <a href="blog-standard.html#"><i class="fab fa-twitter"></i></a>
               <a href="blog-standard.html#"><i class="fab fa-instagram"></i></a>
               <a href="blog-standard.html#"><i class="fab fa-facebook-f"></i></a>
               <a href="blog-standard.html#"><i class="fab fa-pinterest-p"></i></a>
            </div>
         </div>
      </div>
   </div>
                  ...
                  <div class="tp-header-top__left-info">
                     <ul>
                        ...
                        <li>
                           ...
                           <a href="https://template.wphix.com/cdn-cgi/l/email-protection#d9b7bcbcbdb1bcb5a999bab6b4a9b8b7a0f7bab6b4"><span class="__cf_email__" data-cfemail="27494242434f424b576744484a5746495e0944484a">[email&#160;protected]</span></a>
                        </li>
                     </ul>
                  </div>
               </div>
               <div class="col-xl-6 col-lg-6 col-md-6 col-md-6 col-sm-6 col-6 d-none d-sm-block">
                  <div class="tp-header-top__right-wrap d-flex align-items-center justify-content-end">
                     ...
                     <div class="tp-header-top__right-social">
                        <a href="blog-standard.html#"><i class="fa-brands fa-facebook-f"></i></a>
                        <a href="blog-standard.html#"><i class="fa-brands fa-instagram"></i></a>
                        <a href="blog-standard.html#"><i class="fa-brands fa-linkedin-in"></i></a>
                        <a href="blog-standard.html#"><i class="fa-brands fa-twitter"></i></a>
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="col-xl-4 col-lg-4 col-md-6">
                  <div class="tp-footer-top-item tp-footer-top-space-2 d-flex align-items-center">
                     ...
                     <div class="tp-footer-top-info">
                        ...
                        <span>
                           <a href="https://template.wphix.com/cdn-cgi/l/email-protection#1063647164756878757c60797e767f50777d71797c3e737f7d"><span class="__cf_email__" data-cfemail="c7b4b3a6b3a2bfafa2abb7aea9a1a887a0aaa6aeabe9a4a8aa">[email&#160;protected]</span></a>
                        </span>
                        <span>
                  ...
                  <div class="tp-footer-widget footer-col-2">
                     ...
                     <div class="tp-footer-widget-menu">
                        <ul>
                           ...
                           <li><a href="blog-standard.html#">Our Team</a></li>
                           <li><a href="blog-standard.html#">Upcoming Events</a></li>
            ...
            <div class="row align-items-center">
               <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                  <div class="tp-copyright-left-text text-center text-md-start">
                     <p>© Copyright 2023 by <a href="blog-standard.html#">Mayorx.com</a></p>
                  </div>
               </div>
               <div class="col-xl-6 col-lg-6 col-md-6 d-none col-sm-6 d-sm-block">
                  <div class="tp-copyright-right-social text-center text-md-end">
                     <a href="blog-standard.html#"><i class="fa-brands fa-facebook-f"></i></a>
                     <a href="blog-standard.html#"><i class="fa-brands fa-pinterest-p"></i></a>
                     <a href="blog-standard.html#"><i class="fa-brands fa-instagram"></i></a>
                     <a href="blog-standard.html#"><i class="fa-brands fa-twitter"></i></a>
                  </div>
               </div>

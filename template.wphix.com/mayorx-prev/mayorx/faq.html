      ...
      <div class="tpoffcanvas">
         ...
         <div class="tpoffcanvas__contact-info">
            ...
            <ul>
               ...
               <li>
                  ...
                  <a href="https://template.wphix.com/cdn-cgi/l/email-protection#e89b8784899a8d8c8f8da88f85898184c68b8785"><span class="__cf_email__" data-cfemail="92e6faf7fff7e2e7e0f7d2f5fff3fbfebcf1fdff">[email&#160;protected]</span></a>
               </li>
               <li>
         ...
         <div class="tpoffcanvas__social">
            <div class="social-icon">
               <a href="faq.html#"><i class="fab fa-twitter"></i></a>
               <a href="faq.html#"><i class="fab fa-instagram"></i></a>
               <a href="faq.html#"><i class="fab fa-facebook-f"></i></a>
               <a href="faq.html#"><i class="fab fa-pinterest-p"></i></a>
            </div>
         </div>
      </div>
   </div>
                  ...
                  <div class="tp-header-top__left-info">
                     <ul>
                        ...
                        <li>
                           ...
                           <a href="https://template.wphix.com/cdn-cgi/l/email-protection#dab4bfbfbeb2bfb6aa9ab9b5b7aabbb4a3f4b9b5b7"><span class="__cf_email__" data-cfemail="543a3131303c31382414373b3924353a2d7a373b39">[email&#160;protected]</span></a>
                        </li>
                     </ul>
                  </div>
               </div>
               <div class="col-xl-6 col-lg-6 col-md-6 col-md-6 col-sm-6 col-6 d-none d-sm-block">
                  <div class="tp-header-top__right-wrap d-flex align-items-center justify-content-end">
                     ...
                     <div class="tp-header-top__right-social">
                        <a href="faq.html#"><i class="fa-brands fa-facebook-f"></i></a>
                        <a href="faq.html#"><i class="fa-brands fa-instagram"></i></a>
                        <a href="faq.html#"><i class="fa-brands fa-linkedin-in"></i></a>
                        <a href="faq.html#"><i class="fa-brands fa-twitter"></i></a>
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="col-xl-4 col-lg-4 col-md-6">
                  <div class="tp-footer-top-item tp-footer-top-space-2 d-flex align-items-center">
                     ...
                     <div class="tp-footer-top-info">
                        ...
                        <span>
                           <a href="https://template.wphix.com/cdn-cgi/l/email-protection#afdcdbcedbcad7c7cac3dfc6c1c9c0efc8c2cec6c381ccc0c2"><span class="__cf_email__" data-cfemail="384b4c594c5d40505d544851565e57785f55595154165b5755">[email&#160;protected]</span></a>
                        </span>
                        <span>
                  ...
                  <div class="tp-footer-widget footer-col-2">
                     ...
                     <div class="tp-footer-widget-menu">
                        <ul>
                           ...
                           <li><a href="faq.html#">Our Team</a></li>
                           <li><a href="faq.html#">Upcoming Events</a></li>
                           <li><a href="faq.html#">Latest News</a></li>
            ...
            <div class="row align-items-center">
               <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                  <div class="tp-copyright-left-text text-center text-md-start">
                     <p>© Copyright 2023 by <a href="faq.html#">Mayorx.com</a></p>
                  </div>
               </div>
               <div class="col-xl-6 col-lg-6 col-md-6 d-none col-sm-6 d-sm-block">
                  <div class="tp-copyright-right-social text-center text-md-end">
                     <a href="faq.html#"><i class="fa-brands fa-facebook-f"></i></a>
                     <a href="faq.html#"><i class="fa-brands fa-pinterest-p"></i></a>
                     <a href="faq.html#"><i class="fa-brands fa-instagram"></i></a>
                     <a href="faq.html#"><i class="fa-brands fa-twitter"></i></a>
                  </div>
               </div>
